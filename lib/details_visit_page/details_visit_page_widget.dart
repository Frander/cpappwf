...
class DetailsVisitPageWidget extends StatefulWidget {
  const DetailsVisitPageWidget({
    super.key,
  ...
  static String routeName = 'DetailsVisitPage';
  static String routePath = '/detailsVisitPage';

  @override
  State<DetailsVisitPageWidget> createState() => _DetailsVisitPageWidgetState();
}

class _DetailsVisitPageWidgetState extends State<DetailsVisitPageWidget> {
  late DetailsVisitPageModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => DetailsVisitPageModel());
  }
