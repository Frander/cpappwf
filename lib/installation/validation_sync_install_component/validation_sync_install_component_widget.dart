...
import 'validation_sync_install_component_model.dart';
export 'validation_sync_install_component_model.dart';

class ValidationSyncInstallComponentWidget extends StatefulWidget {
  const ValidationSyncInstallComponentWidget({
    super.key,
  ...
  @override
  State<ValidationSyncInstallComponentWidget> createState() =>
      _ValidationSyncInstallComponentWidgetState();
}

class _ValidationSyncInstallComponentWidgetState
    extends State<ValidationSyncInstallComponentWidget> {
  late ValidationSyncInstallComponentModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ValidationSyncInstallComponentModel());
  }
