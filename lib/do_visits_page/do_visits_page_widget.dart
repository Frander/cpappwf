...
class _DoVisitsPageWidgetState extends State<DoVisitsPageWidget> {
  ...
  void initState() {
    ...
    SchedulerBinding.instance.addPostFrameCallback((_) async {
      ...
      unawaited(
        () async {
          _model.optionVoiceSelected = await actions.detectAndComparePhrase(
            context,
            functions
                .extractFieldFromActivities(
                    FFAppState().activitySelected, 'status_name')
                .toList(),
          );
        }(),
      );
                      ...
                      Expanded(
                        child: Padding(
                          ...
                          child: Container(
                            ...
                            child: Builder(
                              builder: (context) {
                                final activityStatusItem = FFAppState()
                                    .activitySelected
                                    .activitiesStatus
                                    .toList();
