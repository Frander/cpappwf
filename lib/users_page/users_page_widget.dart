                    ...
                    children: [
                      FutureBuilder<List<GetAllUsersRow>>(
                        ...
                        builder: (context, snapshot) {
                          ...
                          final listViewGetAllUsersRowList = snapshot.data!;

                          return ListView.builder(
                            padding: EdgeInsets.zero,
                            shrinkWrap: true,
                            scrollDirection: Axis.vertical,
                            itemCount: listViewGetAllUsersRowList.length,
                            itemBuilder: (context, listViewIndex) {
                              final listViewGetAllUsersRow =
                                  listViewGetAllUsersRowList[listViewIndex];
                              return Container(
                                width: double.infinity,
                                height: 100.0,
                                decoration: BoxDecoration(
                                      ...
                                      child: Padding(
                                        ...
                                        child: Column(
                                          ...
                                          children: [
                                            Expanded(
                                              child: Text(
                                                listViewGetAllUsersRow.nameUser,
                                                textAlign: TextAlign.center,
                                                style:
