                    ...
                    child: Column(
                      ...
                      children: [
                        Expanded(
                          child: Builder(
                            builder: (context) {
                              final newItem = FFAppState().newsList.toList();
                              ...
                              return ListView.separated(
                                ...
                                separatorBuilder: (_, __) =>
                                    SizedBox(height: 5.0),
                                itemBuilder: (context, newItemIndex) {
                                  final newItemItem = newItem[newItemIndex];
                                  return Padding(
                                    padding: EdgeInsetsDirectional.fromSTEB(
                                        5.0, 5.0, 5.0, 0.0),
                                    child: InkWell(
                                      ...
                                      onTap: () async {
                                        FFAppState()
                                            .addToNewsAdd(VisitsNewsStruct(
                                          idNew: newItemItem.idNew,
                                          createdAt:
                                              functions.convertToDotNetDateTime(
                                                  getCurrentTimestamp),
