                        ...
                        Expanded(
                          child: InkWell(
                            ...
                            child: Container(
                              ...
                              height: 100.0,
                              decoration: BoxDecoration(
                                color: FFAppState().activitySelectedJSON != null
                                    ? Color(0xFFCCFFCB)
                                    : Color(0xFFFFC0C4),
                                boxShadow: [
                                  BoxShadow(
                                      ...
                                      child: Padding(
                                        ...
                                        child: ClipRRect(
                                          borderRadius:
                                              BorderRadius.circular(8.0),
                                          child: Image.asset(
                                            'assets/images/box-time-svgrepo-com.png',
                                            width: 40.0,
                                            height: double.infinity,
                                            fit: BoxFit.contain,
                                          ),
                              ...
                              onTap: () async {
                                if ((FFAppState().userSelected != null) &&
                                    (FFAppState().userSelected.nameUser !=
                                            '')) {
                                  if (FFAppState().activitySelectedJSON !=
                                      null) {
                                        ...
                                        child: Container(
                                          ...
                                          child: ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8.0),
                                            child: Image.asset(
                                              'assets/images/Animation_-_1736448515232.gif',
                                              fit: BoxFit.contain,
                                            ),
                                          ),
                                        ),
                                            ...
                                            child: Container(
                                              ...
                                              child: Align(
                                                alignment: AlignmentDirectional(
                                                    0.0, 0.0),
                                                child: AutoSizeText(
                                                  '${(FFAppState().visitsAdd.length > 0) || (FFAppState().productsAdd.length > 0) ? 'Hay información pendiente por sincronizar' : 'Sin información pendiente por sincronizar'}',
                                                  textAlign: TextAlign.center,
                                                  minFontSize: 8.0,
                                                  style: FlutterFlowTheme.of(
                                                          context)
