                                                ...
                                                child: ClipRRect(
                                                  borderRadius:
                                                      BorderRadius.circular(
                                                          8.0),
                                                  child: Image.asset(
                                                    'assets/images/2620529_checklist_employee_job_seeker_unemployee_icon.png',
                                                    width: 65.49,
                                                    height: 200.0,
                                                    fit: BoxFit.contain,
                                                  ),
                                                  ...
                                                  children: [
                                                    ...
                                                    Expanded(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Ciclo: ${activityItemItem.cycle.toString()}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
                                                    ...
                                                    Expanded(
                                                      child: Row(
                                                        ...
                                                        children: [
                                                          Text(
                                                            'Efectividad: ${activityItemItem.typeEffectivity}',
                                                            textAlign:
                                                                TextAlign.start,
                                                            style: FlutterFlowTheme
                                                                    .of(context)
